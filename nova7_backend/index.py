...
# CORS Configuration
ALLOWED_ORIGINS = [
    "http://127.0.0.1:5500", "http://127.0.0.1:5501", # Common local dev ports
...
def request_email_verification_endpoint(): # Renamed
    ...
    try:
        ...
        frontend_base_url = os.environ.get("FRONTEND_URL", "http://127.0.0.1:5501") # Adjusted default to 5501
...
def forgot_password_endpoint(): # Renamed
    ...
    if user: # Only send if user exists, but message is generic to prevent user enumeration
        try:
            ...
            frontend_base_url = os.environ.get("FRONTEND_URL", "http://127.0.0.1:5501") # Adjusted default
...
def get_dashboard_summary_endpoint(): # Renamed
    ...
    summary_data = {
        ...
        "netBalance": round(net_balance, 2), "profitMargin": round(profit_margin, 1), # Consistent with dashboard.html
